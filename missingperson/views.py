...
Data='Besides VSEZ Vadlapudi Duvvada, Gajuwaka, Visakhapatnam, Andhra Pradesh 530049'
        ...
        for face_encoding, (top, right, bottom, left) in zip(face_encodings, face_locations):
            ...
            for person in MissingPerson.objects.all():
                ...
                if any(matches):
                    ...
                    context = {"first_name":person.first_name,"last_name":person.last_name,
                                'father_name':person.father_name,"aadhar_number":person.aadhar_number,
                                "missing_from":person.missing_from,"date_time":current_time,"location":Data, "lat":lat, "lon":lng}
